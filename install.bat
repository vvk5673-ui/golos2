@echo off
chcp 65001 >nul
title Golos 2 — Установка

echo.
echo  ╔══════════════════════════════════════════╗
echo  ║         GOLOS 2 — УСТАНОВКА              ║
...
echo Set shortcut = ws.CreateShortcut(ws.SpecialFolders("Desktop") ^& "\Golos 2.lnk") >> "%VBS%"
...
echo shortcut.Description = "Golos 2 — voice input (Alt+X)" >> "%VBS%"
echo shortcut.Save >> "%VBS%"
cscript //nologo "%VBS%"
del "%VBS%"
echo         Ярлык "Golos 2" создан на рабочем столе — OK
echo.

echo  ╔══════════════════════════════════════════╗
echo  ║       УСТАНОВКА ЗАВЕРШЕНА!               ║
echo  ║                                          ║
echo  ║  Запустите Golos 2:                      ║
echo  ║    - Ярлык "Golos 2" на рабочем столе    ║
